...
abstract class BaseUserPeer {
	...
	/** the column name for the SURNAME1 field */
	const SURNAME1 = 'user.SURNAME1';

	/** the column name for the SURNAME2 field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Surname1', 'Surname2', 'Email', 'Password', 'Institution', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'surname1', 'surname2', 'email', 'password', 'institution', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SURNAME1, self::SURNAME2, self::EMAIL, self::PASSWORD, self::INSTITUTION, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'surname1', 'surname2', 'email', 'password', 'institution', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Surname1' => 2, 'Surname2' => 3, 'Email' => 4, 'Password' => 5, 'Institution' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'surname1' => 2, 'surname2' => 3, 'email' => 4, 'password' => 5, 'institution' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SURNAME1 => 2, self::SURNAME2 => 3, self::EMAIL => 4, self::PASSWORD => 5, self::INSTITUTION => 6, self::CREATED_AT => 7, self::UPDATED_AT => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'surname1' => 2, 'surname2' => 3, 'email' => 4, 'password' => 5, 'institution' => 6, 'created_at' => 7, 'updated_at' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
