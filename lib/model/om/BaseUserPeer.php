...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'surname1', 'surname2', 'email', 'institution', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SURNAME1, self::SURNAME2, self::EMAIL, self::INSTITUTION, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'surname1' => 2, 'surname2' => 3, 'email' => 4, 'institution' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SURNAME1 => 2, self::SURNAME2 => 3, self::EMAIL => 4, self::INSTITUTION => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
