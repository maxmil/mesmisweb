...
abstract class BaseDownload extends BaseObject  implements Persistent {
  ...
  const PEER = 'DownloadPeer';
	...
	/**
	 * Initializes internal state of BaseDownload object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Download The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = DownloadPeer::NUM_COLUMNS - DownloadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DownloadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseDownload:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseDownload:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseDownload:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(DownloadPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseDownload:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			DownloadPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getProduct(PropelPDO $con = null)
	{
		if ($this->aProduct === null && ($this->product_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aProduct->addDownloads($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseDownload:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseDownload::%s', $method));
    }
