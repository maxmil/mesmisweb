...
abstract class BaseContentI18nPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ContentI18nMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $criteria, $con);
    }
	...
	public static function doCountJoinContent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ContentI18nPeer::ID,), array(ContentPeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinContent(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{

    foreach (sfMixer::getCallables('BaseContentI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $c, $con);
    }
		...
		$c->addJoin(array(ContentI18nPeer::ID,), array(ContentPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseContentI18nPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseContentI18nPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseContentI18nPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseContentI18nPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ContentI18n) {
...
//
// NOTE: This static code cannot call methods on the ContentI18nPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ContentI18nPeer class:
//
// Propel::getDatabaseMap(ContentI18nPeer::DATABASE_NAME)->addTableBuilder(ContentI18nPeer::TABLE_NAME, ContentI18nPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseContentI18nPeer::DATABASE_NAME)->addTableBuilder(BaseContentI18nPeer::TABLE_NAME, BaseContentI18nPeer::getMapBuilder());
