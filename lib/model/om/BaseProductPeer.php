...
abstract class BaseProductPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'productGroupId', 'mimetype', 'icon', 'priority', 'type', 'state', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PRODUCT_GROUP_ID, self::MIMETYPE, self::ICON, self::PRIORITY, self::TYPE, self::STATE, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'productGroupId' => 1, 'mimetype' => 2, 'icon' => 3, 'priority' => 4, 'type' => 5, 'state' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PRODUCT_GROUP_ID => 1, self::MIMETYPE => 2, self::ICON => 3, self::PRIORITY => 4, self::TYPE => 5, self::STATE => 6, self::CREATED_AT => 7, self::UPDATED_AT => 8, ),
