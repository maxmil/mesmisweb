...
abstract class BaseProductPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ProductGroupId', 'Mimetype', 'Priority', 'Type', 'State', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'productGroupId', 'mimetype', 'priority', 'type', 'state', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PRODUCT_GROUP_ID, self::MIMETYPE, self::PRIORITY, self::TYPE, self::STATE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'product_group_id', 'mimetype', 'priority', 'type', 'state', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProductGroupId' => 1, 'Mimetype' => 2, 'Priority' => 3, 'Type' => 4, 'State' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'productGroupId' => 1, 'mimetype' => 2, 'priority' => 3, 'type' => 4, 'state' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PRODUCT_GROUP_ID => 1, self::MIMETYPE => 2, self::PRIORITY => 3, self::TYPE => 4, self::STATE => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'product_group_id' => 1, 'mimetype' => 2, 'priority' => 3, 'type' => 4, 'state' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function doCountJoinProductGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProductPeer::PRODUCT_GROUP_ID,), array(ProductGroupPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseProductPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseProductPeer', $c, $con);
		...
		$c->addJoin(array(ProductPeer::PRODUCT_GROUP_ID,), array(ProductGroupPeer::ID,), $join_behavior);
      ...
      call_user_func($callable, 'BaseProductPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Product) to the collection in $obj2 (ProductGroup)
				$obj2->addProduct($obj1);
