...
abstract class BaseNewsItem extends BaseObject  implements Persistent {
  ...
  const PEER = 'NewsItemPeer';
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = NewsItemPeer::TITLE;
		}
	...
	public function setDescrip($v)
	{
		...
		if ($this->descrip !== $v) {
			$this->descrip = $v;
			$this->modifiedColumns[] = NewsItemPeer::DESCRIP;
		}
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = NewsItemPeer::BODY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->photo_filename = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 9; // 9 = NewsItemPeer::NUM_COLUMNS - NewsItemPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPhotoFilename($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsItemPeer::TITLE)) $criteria->add(NewsItemPeer::TITLE, $this->title);
		if ($this->isColumnModified(NewsItemPeer::DESCRIP)) $criteria->add(NewsItemPeer::DESCRIP, $this->descrip);
		if ($this->isColumnModified(NewsItemPeer::BODY)) $criteria->add(NewsItemPeer::BODY, $this->body);
