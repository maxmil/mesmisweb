...
/**
 * Base class that represents a row from the 'product_group_i18n' table.
 *
 * 
 *
...
abstract class BaseproductGroupI18n extends BaseObject  implements Persistent {
  ...
  const PEER = 'productGroupI18nPeer';
	...
	/**
	 * Initializes internal state of BaseproductGroupI18n object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     productGroupI18n The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = productGroupI18nPeer::NUM_COLUMNS - productGroupI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aProductGroup !== null && $this->id !== $this->aProductGroup->getId()) {
			$this->aProductGroup = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = productGroupI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseproductGroupI18n:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			productGroupI18nPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function getProductGroup(PropelPDO $con = null)
	{
		if ($this->aProductGroup === null && ($this->id !== null)) {
			...
			$c->add(ProductGroupPeer::ID, $this->id);
			...
			/* The following can be used additionally to
			   ...
			   $this->aProductGroup->addproductGroupI18ns($this);
			 */
		}
