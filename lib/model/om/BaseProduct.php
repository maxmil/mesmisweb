...
abstract class BaseProduct extends BaseObject  implements Persistent {
  ...
  protected $culture;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mimetype = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
  ...
  public function getPhotoFilename($culture = null)
  {
    return $this->getCurrentProductI18n($culture)->getPhotoFilename();
  }

  public function setPhotoFilename($value, $culture = null)
  {
    $this->getCurrentProductI18n($culture)->setPhotoFilename($value);
  }

  public function getAttachFilename($culture = null)
  {
    return $this->getCurrentProductI18n($culture)->getAttachFilename();
  }

  public function setAttachFilename($value, $culture = null)
  {
    $this->getCurrentProductI18n($culture)->setAttachFilename($value);
  }

  public function getUrl($culture = null)
  {
    return $this->getCurrentProductI18n($culture)->getUrl();
  }

  public function setUrl($value, $culture = null)
  {
    $this->getCurrentProductI18n($culture)->setUrl($value);
  }
