...
abstract class BaseContentPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'alias', 'state', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ALIAS, self::STATE, self::CREATED_AT, self::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'alias' => 1, 'state' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ALIAS => 1, self::STATE => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ContentMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseContentPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseContentPeer', $criteria, $con);
    }
  ...
  /**
   * Selects a collection of Content objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseContentPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseContentPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseContentPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseContentPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseContentPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseContentPeer', $values, $con, $ret);
    }
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c = new Criteria(ContentI18nPeer::DATABASE_NAME);
			
			$c->add(ContentI18nPeer::ID, $obj->getId());
			$affectedRows += ContentI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
//
// NOTE: This static code cannot call methods on the ContentPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ContentPeer class:
//
// Propel::getDatabaseMap(ContentPeer::DATABASE_NAME)->addTableBuilder(ContentPeer::TABLE_NAME, ContentPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseContentPeer::DATABASE_NAME)->addTableBuilder(BaseContentPeer::TABLE_NAME, BaseContentPeer::getMapBuilder());
