...
abstract class BaseVisitPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (VisitPeer::USER_ID, VisitPeer::IP, VisitPeer::CREATED_AT, VisitPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (VisitPeer::USER_ID => 0, VisitPeer::IP => 1, VisitPeer::CREATED_AT => 2, VisitPeer::ID => 3, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.VisitMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = VisitPeer::getTableMap();
	...
	const COUNT = 'COUNT(visit.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT visit.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(VisitPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(VisitPeer::COUNT);
		}
		...
		$rs = VisitPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return VisitPeer::populateObjects(VisitPeer::doSelectRS($criteria, $con));
	}
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(VisitPeer::USER_ID, UserPeer::ID);
	...
	public static function doSelectJoinUser(Criteria $c, $con = null)
	{
		...
		$startcol = (VisitPeer::NUM_COLUMNS - VisitPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		UserPeer::addSelectColumns($c);

		$c->addJoin(VisitPeer::USER_ID, UserPeer::ID);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		VisitPeer::addSelectColumns($c);
		$startcol2 = (VisitPeer::NUM_COLUMNS - VisitPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 {
		if ($con === null) {
			$con = Propel::getConnection(VisitPeer::DATABASE_NAME);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Visit) {
...
if (Propel::isInit()) {
			try {
		BaseVisitPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('lib.model.map.VisitMapBuilder');
}
