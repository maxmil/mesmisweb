...
abstract class BaseContent extends BaseObject  implements Persistent {
  ...
  const PEER = 'ContentPeer';
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = ContentPeer::BODY;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ContentPeer::STATE))) {
				return false;
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContentPeer::BODY)) $criteria->add(ContentPeer::BODY, $this->body);
